...
interface SupplierFiltersProps {
    filters: { search: string; status: string; tax_id: string };
    updateFilter: (key: keyof SupplierFiltersProps['filters'], value: string) => void;
    applyFilters: () => void;
    clearFilters: () => void;
    hasActiveFilters: boolean;
    navigate: (page?: number, overrides?: Partial<{ search: string; status: string; tax_id: string }>) => void;
}
